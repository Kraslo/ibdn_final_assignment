...
object MakePrediction {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark
      .readStream
      .format("kafka")
      .option("kafka.bootstrap.servers", "kafkaibdn:9092")
    ...
    val dataStreamWriter = finalPredictions
      ...
      .writeStream
      .format("mongodb")
      .option("spark.mongodb.connection.uri", "mongodb://mongotainer:27017/")
